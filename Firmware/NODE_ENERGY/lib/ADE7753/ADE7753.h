...
Giao diện người dùng tương tự dành cho hệ thống đơn giản.
...
// Class Atributes
                	// Chip Select ADE7753 sau đó được thêm vào 8 để tương thích với hàm digitalWrite()
#define WRITE 0x80				//Valor del addres para la funcion Write.
#define CLKIN 3579545         	//Tần số hoạt động của ADE7753 , max 4MHz
#define PERIODO 50				// Tần số dòng điện
